 ...
 */
function owayt_custom_excerpt_length( $length ) {
	return 26;
}
add_filter( 'excerpt_length', 'owayt_custom_excerpt_length', 999 );


/**
 * Set the format for the more in excerpt, return ... instead of [...]
 */
function owayt_excerpt_more( $more ) {
	return '...';
}
add_filter('excerpt_more', 'owayt_excerpt_more');
